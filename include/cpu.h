...
void arch_init();
void register_intr(unsigned char num, void *ISR, unsigned short segment,
		   unsigned char dpl);
void register_trap(unsigned char num, void *ISR, unsigned short segment,
		   unsigned char dpl);

static inline void
set_int_gate(unsigned char num, void *ISR)
{
	register_intr(num, ISR, 1 << 3, 0);
}

static inline void
set_system_gate(unsigned char num, void *ISR)
{
	register_intr(num, ISR, 1 << 3, 3);
}

static inline void
set_irq_gate(unsigned char irq, void *ISR)
{
