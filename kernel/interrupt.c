...
void do_device_not_present(){
	panic("device not present error caught");
}
void do_double_fault(unsigned int err_code){
	panic("double fault caught");
}
void do_i387_overrun(){
	panic("i387 overrun caught");
}
void do_illegal_tss(unsigned int err_code){
	panic("illegal tss caught");
}
void do_illegal_segment(unsigned int err_code){
	panic("illegal segment caught");
}
void do_stack_overflow(unsigned int err_code){
	panic("stack overflow caught");
}
void do_general_protect(unsigned int err_code){
	panic("general protection exception caught");
}
void do_page_fault(unsigned int err_code){
